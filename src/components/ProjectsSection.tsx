...
const projects: Project[] = [
  {
    ...
    images: [
      "../public/assets/resumator/main1.png",
      "../public/assets/resumator/main2.png",
      "../public/assets/resumator/main3.png",
      "../public/assets/resumator/template_select.png",
      "../public/assets/resumator/make_resume1.png",
      "../public/assets/resumator/make_resume2.png",
      "../public/assets/resumator/make_resume3.png",
      "../public/assets/resumator/make_resume4.png",
      "../public/assets/resumator/resume_preview.png",
    ],
  ...
  },
  {
    ...
    images: [
      "../public/assets/concisio/Main Page.png",
      "../public/assets/concisio/Mp2.png",
      "../public/assets/concisio/Summarizer.png",
      "../public/assets/concisio/Contact Us.png",
    ],
  ...
  },
  {
    ...
    images: [
      "../public/assets/travelease/CoverPage.png",
      "../public/assets/travelease/Login.png",
      "../public/assets/travelease/Signup.png",
      "../public/assets/travelease/Admin.png",
      "../public/assets/travelease/Traveler.png",
      "../public/assets/travelease/TourOperator.png",
      "../public/assets/travelease/Guide.png",
      "../public/assets/travelease/Hotel.png",
      "../public/assets/travelease/Transport.png",
    ],
  ...
  },
  {
    ...
    images: [
      "../public/assets/cellsense/Dashboard.png",
      "../public/assets/cellsense/Analytics.png",
      "../public/assets/cellsense/History.png",
    ],
  ...
  },
  {
    ...
    images: [
      "../public/assets/swiftcart/POS.png",
      "../public/assets/swiftcart/Receipt.png",
      "../public/assets/swiftcart/dashboard.png",
      "../public/assets/swiftcart/Manage Products.png",
      "../public/assets/swiftcart/Manage Discounts.png",
      "../public/assets/swiftcart/Manage Cashiers.png",
      "../public/assets/swiftcart/Sales Reports.png",
      "../public/assets/swiftcart/Inventory Reports.png",
      "../public/assets/swiftcart/Discount Reports.png",
      "../public/assets/swiftcart/Cashier Performance.png",
      "../public/assets/swiftcart/Flop Products.png",
      "../public/assets/swiftcart/login.png",
    ],
    tech: ["JavaFX"],
    github: "#",
    category: "Desktop",
